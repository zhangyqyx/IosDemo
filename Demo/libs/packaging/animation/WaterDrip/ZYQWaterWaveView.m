...
@interface ZYQWaterWaveView() <CAAnimationDelegate, UICollectionViewDelegate>
...
@property (nonatomic, strong) ZYQDripView *dripView;
...
@end
@implementation ZYQWaterWaveView
...
- (void)showDripAnmin:(NSNumber *)percent{
    ...
    self.dripView = [[ZYQDripView alloc] initWithColor:self.dripVColor];
    ...
    CGFloat waveViewHeight = self.frame.size.height *0.3;
