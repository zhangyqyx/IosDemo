...
//判断是否为iPhone X
#define ZYQ_iPhoneX ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1125, 2436), [[UIScreen mainScreen] currentMode].size) : false)

#pragma mark -- 高度
#define ZYQ_NavigationH     44
#define ZYQ_iphoneXBAddH    34
#define ZYQ_bottomSpace     (ZYQ_iPhoneX == true ?ZYQ_iphoneXBAddH:0)
#define ZYQ_TopH            (ZYQ_iPhoneX == true ?(64 + 24):(64))
#define ZYQ_StatusBarH      (ZYQ_iPhoneX == true ?(20 + 24):(20))
#define ZYQ_TabbarH         (ZYQ_iPhoneX == true ?(49 + 34):(49))
...
#define mark - app信息
// app信息
#define ZYQ_appInfoDic [[NSBundle mainBundle] infoDictionary]
// app版本
#define ZYQ_appVersion [ZYQ_appInfoDic objecZYQorKey:@"CFBundleShortVersionString"]
// app名称
#define ZYQ_appName  [ZYQ_appInfoDic objecZYQorKey:@"CFBundleDisplayName"]
// app build版本
#define ZYQ_appBuild = [ZYQ_appInfoDic objecZYQorKey:@"CFBundleVersion"]
#pragma mark -- 获取系统版本
