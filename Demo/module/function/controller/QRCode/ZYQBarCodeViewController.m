...
@interface ZYQBarCodeViewController ()<ZYQCodeScanManagerDelegate>
/** 扫描视图 */
...
- (void)setupManager {
    ...
    [_manager ZYQ_scanQRImage:CGRectMake(0, 0, 260, 80) viewSize:[UIScreen mainScreen].bounds currentController:self];
